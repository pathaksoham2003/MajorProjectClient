  ...
  return (
    <footer className="bg-background py-10 border-t">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          <h3 className="font-semibold text-text mb-4">Useful Links</h3>
          <ul>
            <li>
              <a className="text-text hover:text-text/40">
                Legal & Privacy
              </a>
            </li>
            <li>
        ...
        <div>
          <h3 className="font-semibold text-text mb-4">My Account</h3>
          <ul>
            <li>
              <a className="text-text hover:text-text/40">
                My Profile
      ...
      <div className="max-w-7xl mx-auto mt-10 flex flex-col md:flex-row justify-between items-center text-text">
        ...
        <div className="mt-4 md:mt-0 text-center md:text-right">
          ...
          <p className="text-text">+99 0214 2542 223</p>
          <p className="text-sm">
